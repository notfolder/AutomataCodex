...
**実装ファイル:**
- `pyproject.toml`（ワークスペースルート：`[tool.uv.workspace]` で `packages/*` を管理）
- `docker-compose.yml`
- `.env.example`
- `.dockerignore`
...
- `packages/producer/pyproject.toml`
- `packages/consumer/pyproject.toml`
- `packages/backend/pyproject.toml`

**実装内容:**  
ルートの `pyproject.toml` に `[tool.uv.workspace]` を設定し、`packages/*` 配下の4パッケージ（shared・producer・consumer・backend）をワークスペースメンバーとして管理する。  
producer・consumer・backend の3つのPythonサービスは `packages/shared` を共通ライブラリとして依存し、コード重複なしに `models/`・`database/`・`gitlab_client/`・`config/` を共有する。  
各 `docker/<サービス>/Dockerfile` は `context: .`（ルート）を共有ビルドコンテキストとして使用し、`docker-compose.yml` の `build` 指定は `{ context: ., dockerfile: docker/<サービス>/Dockerfile }` 形式とする。  
...
**実装ファイル:**
- `packages/shared/src/shared/config/config_manager.py`
- `packages/shared/src/shared/config/models.py`
- `config.yaml`
...
**実装ファイル:**
- `packages/shared/src/shared/models/task.py`
- `packages/shared/src/shared/models/graph_definition.py`
- `packages/shared/src/shared/models/agent_definition.py`
- `packages/shared/src/shared/models/prompt_definition.py`
...
`packages/shared` パッケージに配置し、producer・consumer・backendの全サービスから参照可能にする。
...
**実装ファイル:**
- `packages/shared/src/shared/database/schema.sql`
- `packages/shared/src/shared/database/migrations/`（マイグレーションファイル群）
- `packages/shared/src/shared/database/connection.py`
...
**実装ファイル:**
- `packages/shared/src/shared/database/repositories/user_repository.py`
- `packages/shared/src/shared/database/repositories/task_repository.py`
- `packages/shared/src/shared/database/repositories/workflow_definition_repository.py`
- `packages/shared/src/shared/database/repositories/context_repository.py`
- `packages/shared/src/shared/database/repositories/token_usage_repository.py`
...
**実装ファイル:**
- `packages/shared/src/shared/gitlab_client/gitlab_client.py`
...
**実装ファイル:**
- `packages/consumer/src/consumer/mcp/mcp_client.py`
...
**実装ファイル:**
- `packages/consumer/src/consumer/mcp/mcp_client_factory.py`
...
**実装ファイル:**
- `packages/consumer/src/consumer/execution/execution_environment_manager.py`
...
**実装ファイル:**
- `packages/consumer/src/consumer/providers/chat_history_provider.py`
- `packages/consumer/src/consumer/providers/planning_context_provider.py`
- `packages/consumer/src/consumer/providers/tool_result_context_provider.py`
- `packages/consumer/src/consumer/providers/task_inheritance_context_provider.py`
- `packages/consumer/src/consumer/providers/context_compression_service.py`
- `packages/consumer/src/consumer/providers/context_storage_manager.py`
...
**実装ファイル:**
- `packages/consumer/src/consumer/analysis/environment_analyzer.py`
- `packages/consumer/src/consumer/planning/pre_planning_manager.py`
...
**実装ファイル:**
- `packages/consumer/src/consumer/agents/configurable_agent.py`
...
**実装ファイル:**
- `packages/consumer/src/consumer/executors/base_executor.py`
- `packages/consumer/src/consumer/executors/user_resolver_executor.py`
- `packages/consumer/src/consumer/executors/content_transfer_executor.py`
- `packages/consumer/src/consumer/executors/plan_env_setup_executor.py`
- `packages/consumer/src/consumer/executors/exec_env_setup_executor.py`
- `packages/consumer/src/consumer/executors/branch_merge_executor.py`
...
**実装ファイル:**
- `packages/consumer/src/consumer/middleware/i_middleware.py`
- `packages/consumer/src/consumer/middleware/comment_check_middleware.py`
- `packages/consumer/src/consumer/middleware/infinite_loop_detection_middleware.py`
- `packages/consumer/src/consumer/middleware/token_usage_middleware.py`
- `packages/consumer/src/consumer/middleware/error_handling_middleware.py`
...
**実装ファイル:**
- `packages/consumer/src/consumer/tools/progress_reporter.py`
- `packages/consumer/src/consumer/tools/mermaid_graph_renderer.py`
- `packages/consumer/src/consumer/tools/progress_comment_manager.py`
...
**実装ファイル:**
- `packages/consumer/src/consumer/tools/todo_management_tool.py`
- `packages/consumer/src/consumer/tools/issue_to_mr_converter.py`
...
**実装ファイル:**
- `packages/consumer/src/consumer/definitions/definition_loader.py`
...
**実装ファイル:**
- `packages/consumer/src/consumer/factories/workflow_factory.py`
- `packages/consumer/src/consumer/factories/executor_factory.py`
- `packages/consumer/src/consumer/factories/agent_factory.py`
- `packages/consumer/src/consumer/factories/task_strategy_factory.py`
...
**実装ファイル:**
- `packages/consumer/src/consumer/agents/guideline_learning_agent.py`
...
**実装ファイル:**
- `packages/consumer/src/consumer/strategies/i_task_strategy.py`
- `packages/consumer/src/consumer/strategies/issue_to_mr_conversion_strategy.py`
- `packages/consumer/src/consumer/strategies/issue_only_strategy.py`
- `packages/consumer/src/consumer/strategies/merge_request_strategy.py`

**実装内容:**  
ITaskStrategyインターフェースは `execute(task)` を抄象メソッドとして定義し、ConsumerがTaskStrategyFactoryから受け取る戦略オブジェクトの共通型とする。  
...
**実装ファイル:**
- `packages/producer/src/producer/producer.py`
- `packages/producer/src/producer/gitlab_event_handler.py`
...
**実装ファイル:**
- `packages/consumer/src/consumer/consumer.py`
- `packages/consumer/src/consumer/task_processor.py`
...
**実装ファイル:**
- `packages/backend/src/backend/user_management/api.py`
- `packages/backend/src/backend/user_management/auth.py`
- `packages/backend/src/backend/user_management/encryption.py`
- `packages/backend/src/backend/user_management/user_config_client.py`
...
**実装ファイル:**
- `packages/backend/src/backend/user_management/cli/create_admin.py`
...
**実装ファイル:**
- `packages/shared/src/shared/database/seeds/seed_workflow_definitions.py`
...
│
├── docker/
│   ├── producer/                   # Python: packages/producer 起動
│   ├── consumer/                   # Python: packages/consumer 起動
│   ├── backend/                    # Python: uvicorn packages/backend 起動
│   └── frontend/                   # Node.js: Vue.js ビルド
│
├── packages/
